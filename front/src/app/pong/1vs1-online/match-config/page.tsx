  ...
  useEffect(() => {
    ...
    const handleIngameComm = (data: any) => {
      ...
      if (!hasNavigated.current) {
        ...
        router.push(`/pong/1vs1-online/game?roomId=${gameRoomId}`);
      }
    };
    ...
    <div style={styles.container}>
      ...
      <div style={styles.matchInfo}>
        <div style={{
          ...
          <span style={{
            ...styles.playerStatus,
            backgroundColor: (amIPlayer1 ? isReady : opponentReady) ? '#2ecc71' : '#e74c3c',
            color: 'white',
          }}>
            {(amIPlayer1 ? isReady : opponentReady) ? '✓ Prêt' : 'En attente...'}
          </span>
        </div>
